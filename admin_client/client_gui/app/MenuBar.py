...
from .DeleteDialog.DeleteDialog import DeleteDialog
class MenuBar:
    w=None
    bar=None
    ...
    def init_about_dialog(self):
        ...
        uic.loadUi("app/forms/About.ui",aboutDialog)
        aboutDialog.close.rejected.connect(aboutDialog.reject)
        aboutDialog.program_img.setPixmap(QPixmap("app/Icons/SaffronExplorer.png"))
    ...
    def add_new_department(self):
        ...
        uic.loadUi("app/forms/NewDepartment.ui",self.new_department_dialog)
    ...
    def add_new_address(self):
        ...
        uic.loadUi("app/forms/NewAddress.ui",self.new_address_dialog)
    ...
    def add_new_brand(self):
        ...
        uic.loadUi("app/forms/NewEntityGeneral.ui",self.new_brand_dialog)
    ...
    def add_new_priceUnit(self):
        ...
        uic.loadUi("app/forms/NewUnit.ui",self.new_priceUnit_dialog)
    ...
    def add_new_vendor(self):
        ...
        uic.loadUi("app/forms/NewEntityGeneral.ui",self.new_vendor_dialog)
    ...
    def add_new_manufacturer(self):
        ...
        uic.loadUi("app/forms/NewEntityGeneral.ui",self.new_manufacturer_dialog)
        print(self.w.address)
    ...
    def init_action_new_department(self):
        self.new_department=QAction(QIcon("app/Icons/new_department.png"),"&Department",self.w)
    ...
    def init_action_new_address(self):
        self.new_address=QAction(QIcon("app/Icons/new_address.png"),"&Address",self.w)
    ...
    def init_action_new_manufacturer(self):
        self.new_manufacturer=QAction(QIcon("app/Icons/new_manufacturer.png"),"&Manufacturer",self.w)
    ...
    def init_action_new_vendor(self):
        self.new_vendor=QAction(QIcon("app/Icons/new_vendor.png"),"&Vendor",self.w)
    ...
    def init_action_new_weightUnit(self):
        self.new_weightUnit=QAction(QIcon("app/Icons/new_weightUnit.png"),"&Weight Unit",self.w)
    ...
    def init_action_new_priceUnit(self):
        self.new_priceUnit=QAction(QIcon("app/Icons/new_priceUnit.png"),"&Price Unit",self.w)
    ...
    def init_action_new_brand(self):
        self.new_brand=QAction(QIcon("app/Icons/new_brand.png"),"&Brand",self.w)
