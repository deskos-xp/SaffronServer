...
class DisplayDataDialog:
    ...
    def run(self):
        ...
        uic.loadUi("MainWindow/forms/DisplayProductDataDialog.ui",self.widget)
...
class DisplayItem:
    ...
    def show_Address(self):
        ...
        uic.loadUi("MainWindow/forms/AddressView.ui",self.addressDialog)
    ...
    def run(self):
        ...
        if self.ui == "department":
            uic.loadUi("MainWindow/forms/DepartmentView.ui",self.widget)
            self.widget.name.setText(self.data.get("name"))
            self.widget.store_department_number.setValue(self.data.get("store_department_number"))
            self.widget.ID.setValue(self.data.get("id"))
            self.widget.comment.setText(self.data.get("comment"))
        else:
            uic.loadUi("MainWindow/forms/GeneralViewDialog.ui",self.widget)    
            self.widget.name.setText(self.data.get("name"))
...
class DisplayGeneralView:
    ...
    def run(self):
        self.widget=QDialog(self.w)
        uic.loadUi("MainWindow/forms/ContainerGrid.ui",self.widget)
